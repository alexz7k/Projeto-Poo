                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="addRecord.jsp">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="telefone_vendedor" name="telefone_endedor" rows="3"></textarea>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" action="editRecord.jsp">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="category" name="category" value="<%= rs.getString("category") %>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="sallerName" name="sallerName" value="<%= rs.getString("nomeVendedor") %>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="sallerPhone" class="form-label">saller Phone:</label>
                                       <!--alterar para tipo numerico--> <input type="text" class="form-control" id="sallerPhone" name="sallerPhone" value="<%= rs.getInt("telVendedor") %>">
                                    </div>
                                    <div class="mb-3">
