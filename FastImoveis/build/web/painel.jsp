                    ...
                    <div class="modal-body">
                        <form method="post" action="editRecord.jsp">  <!-- Formulário para editar os detalhes do registro -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="endereco" name="endereco" value="<%= rs.getString("endereco") %>">
                            </div>
                            <div class="mb-3">
                                <label for="categoria" class="form-label">Categoria:</label>
                                <select class="form-select" id="categoria" name="categoria">
                                    <option value="Casa" <%= rs.getString("categoria").equals("Casa") ? "selected" : "" %>>Casa</option>
                                    <option value="Apartamento" <%= rs.getString("categoria").equals("Apartamento") ? "selected" : "" %>>Apartamento</option>
                                    <option value="Kitnet" <%= rs.getString("categoria").equals("Kitnet") ? "selected" : "" %>>Kitnet</option>
                                    <option value="Sobrado" <%= rs.getString("categoria").equals("Sobrado") ? "selected" : "" %>>Sobrado</option>
                                    <option value="Mansão" <%= rs.getString("categoria").equals("Mansão") ? "selected" : "" %>>Mansão</option>
                                </select>
                            </div>
